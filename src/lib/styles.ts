...
export const s = {
  ...
  textMuted: "text-xs text-gray-600",
  ...
  iconInteractive:
    "rounded-lg bg-gray-50 group-hover:bg-primary/10 flex items-center justify-center text-gray-600 group-hover:text-primary transition-colors",

  // ---- Inputs ----
  inputBase:
    "w-full px-4 h-12 bg-slate-50 border border-slate-200 rounded-xl text-sm placeholder:text-slate-500 transition-colors",
  inputFocus:
    "focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary",
  inputDisabled: "disabled:opacity-50 disabled:cursor-not-allowed",
  searchInputField:
    "block w-full pl-11 pr-4 py-2.5 border-none rounded-xl bg-white text-slate-900 placeholder-slate-500 focus:ring-2 focus:ring-primary/20 text-[15px] shadow-sm transition-all",
  ...
  navItemActive: "bg-white/10 text-white font-medium",
  navItemInactive: "text-white/70 hover:bg-white/5 hover:text-white",
  navIcon: "group-hover:scale-110 transition-transform",

  // ---- Sidebar ----
  sidebar: "w-[260px] h-full bg-slate-900 text-white flex flex-col shrink-0",
  sidebarLogo: "px-5 pt-6 pb-4",
  sidebarNav: "flex-1 overflow-y-auto px-3 py-2",
  sidebarFooter: "px-5 py-4 border-t border-white/10",
  ...
  // ---- Tables ----
  tableHeader:
    "border-b border-slate-100 dark:border-slate-800 text-[11px] uppercase tracking-wider text-slate-600 font-semibold bg-slate-50/50 dark:bg-slate-900",
  tableRow:
  ...
  segmentInactive:
    "text-slate-600 hover:text-slate-700 hover:bg-slate-200/50 font-medium",
  ...
  notificationTime: "text-[11px] text-gray-600 whitespace-nowrap",
  ...
  ratingStarActive: "text-amber-700",
  ratingStarInactive: "text-slate-300",
  ...
  stepperCircleUpcoming: "bg-slate-100 text-slate-600",
  ...
  commandGroupLabel: "px-3 py-1.5 text-[11px] font-bold text-slate-600 uppercase tracking-wider",
  ...
  uploadItemIcon: "flex items-center justify-center w-10 h-10 rounded-lg bg-slate-100 text-slate-600",
