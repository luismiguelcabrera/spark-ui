...
const toolbarConfig: Record<string, ToolbarButtonConfig> = {
  ...
  underline: { command: "underline", icon: "format_underline", label: "Underline", shortcut: "Ctrl+U" },
  strikethrough: { command: "strikeThrough", icon: "strikethrough", label: "Strikethrough" },
  heading: { command: "formatBlock", commandArg: "H2", icon: "heading-2", label: "Heading" },
  bulletList: { command: "insertUnorderedList", icon: "list", label: "Bullet list" },
