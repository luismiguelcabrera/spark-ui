...
export const Gallery: Story = {
  render: (args) => (
    <div className="flex flex-col gap-8">
      <div>
        <p className="text-xs font-semibold text-muted-foreground uppercase mb-2">Landscape (16:9)</p>
        <Image
          {...args}
          src="https://images.unsplash.com/photo-1506744038136-46273834b3fb?w=600&h=400&fit=crop"
          alt="Mountains"
      ...
      <div className="flex gap-4">
        <div>
          <p className="text-xs font-semibold text-muted-foreground uppercase mb-2">Square</p>
          <Image
            src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=200&h=200&fit=crop"
            alt="Profile"
            width={150}
        ...
        <div>
          <p className="text-xs font-semibold text-muted-foreground uppercase mb-2">Circle</p>
          <Image
            src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=200&h=200&fit=crop"
            alt="Profile circle"
            width={150}
        ...
        <div>
          <p className="text-xs font-semibold text-muted-foreground uppercase mb-2">Fallback</p>
          <Image
            alt="Missing"
            width={150}
            height={150}
      ...
      <div>
        <p className="text-xs font-semibold text-muted-foreground uppercase mb-2">Contain fit</p>
        <Image
          src="https://images.unsplash.com/photo-1517694712202-14dd9538aa97?w=600&h=400&fit=crop"
          alt="Contained"
          width="100%"
