  ...
  ({ className, size = "md", ...props }, ref) => (
    <div
      ...
      className={cn(
        ...
        "[&>blockquote]:border-l-4 [&>blockquote]:border-primary/30 [&>blockquote]:pl-4 [&>blockquote]:italic [&>blockquote]:text-slate-600 [&>blockquote]:my-4",
        "[&>pre]:rounded-xl [&>pre]:bg-slate-950 [&>pre]:p-4 [&>pre]:text-sm [&>pre]:text-slate-100 [&>pre]:overflow-x-auto [&>pre]:my-4",
        "[&>code]:rounded-md [&>code]:bg-slate-100 [&>code]:px-1.5 [&>code]:py-0.5 [&>code]:text-sm [&>code]:text-slate-800",
        ...
        "[&>table>thead>tr>th]:border-b [&>table>thead>tr>th]:border-slate-200 [&>table>thead>tr>th]:px-4 [&>table>thead>tr>th]:py-2 [&>table>thead>tr>th]:text-left [&>table>thead>tr>th]:text-sm [&>table>thead>tr>th]:font-semibold",
        "[&>table>tbody>tr>td]:border-b [&>table>tbody>tr>td]:border-slate-100 [&>table>tbody>tr>td]:px-4 [&>table>tbody>tr>td]:py-2 [&>table>tbody>tr>td]:text-sm",
