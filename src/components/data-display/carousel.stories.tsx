...
const slides = [
  <Slide key="1" color="bg-blue-600" label="Slide 1" />,
  <Slide key="2" color="bg-green-700" label="Slide 2" />,
  <Slide key="3" color="bg-purple-600" label="Slide 3" />,
  <Slide key="4" color="bg-orange-600" label="Slide 4" />,
  <Slide key="5" color="bg-pink-600" label="Slide 5" />,
  <Slide key="6" color="bg-teal-700" label="Slide 6" />,
];
