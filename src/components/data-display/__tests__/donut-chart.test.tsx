...
describe("DonutChart", () => {
  it("renders an SVG element", () => {
    const { container } = render(<DonutChart data={sampleData} animate={false} />);
  ...
  it("forwards ref", () => {
    ...
    render(<DonutChart ref={ref} data={sampleData} animate={false} />);
  ...
  it("merges custom className", () => {
    const { container } = render(
      <DonutChart data={sampleData} animate={false} className="custom" />,
    );
  ...
  it("renders legend when showLegend is true", () => {
    const { container } = render(
      <DonutChart data={sampleData} animate={false} showLegend />,
    );
  ...
  it("applies custom size", () => {
    const { container } = render(
      <DonutChart data={sampleData} animate={false} size={300} />,
    );
    const svg = container.querySelector("svg");
  ...
  it("renders center label when provided", () => {
    render(
      <DonutChart data={sampleData} animate={false} centerLabel={<span>Total</span>} />,
    );
