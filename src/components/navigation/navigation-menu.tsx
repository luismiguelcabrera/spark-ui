          ...
          return (
            ...
            >
              ...
              {hasChildren && isOpen && (
                <div
                  className={cn(
                    "absolute z-50 bg-white border border-slate-200 rounded-xl shadow-float p-2",
                  ...
                  {item.children!.map((child) => (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className={cn("text-sm font-medium", child.active ? "text-primary" : "text-slate-700")}>
                          {child.label}
                        </div>
                        {child.description && (
